...
void ChangeUser(uint16_t user_id) {
  static unsigned char write_00002_00000[] = "\xc3\x3c\x03\x00\x02\x00\xd1\x70";
...
int main(void) {
  ...
  do {
    //*** writing data
    static unsigned char write_00000_00000[] = "\xc3\x3c\x33\x00\x01\x00\x00";
  ...
  do {
    ...
    //**** read match data
    static unsigned char match_00000_00000[] = "\xc3\x3c\x44\x77\x05\x00";
    free(read_00000);
    if (read_00000_ptr) {
    }  // silence unused variable warning if any
  } while (0);
  ...
  do {
    //*** writing data
    static unsigned char write_00037_00000[] = "\xc3\x3c\x0b\x00\x01\x00\x00";
  ...
  do {
    //*** writing data
    static unsigned char write_00038_00000[] = "\xc3\x3c\xff\x00\x01\x00\x00";
