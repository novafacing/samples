...
asm_t iset[] = {{PUSH, "push", 3, 0}, {POP, "pop", 1, 0}, {MOV, "mov", 1, 3},
                {ADD, "add", 1, 3},   {SUB, "sub", 1, 3}, {MUL, "mul", 1, 3},
                {DIV, "div", 1, 3},   {OUT, "out", 3, 0}, {MOD, "mod", 1, 3},
                {SHL, "shl", 1, 3},   {SHR, "shr", 1, 3}, {EXC, "exc", 1, 1},
                {SWP, "swp", 1, 0},   {0, NULL, 0, 0}};
...
int main() { _terminate(parse_instructions()); }
