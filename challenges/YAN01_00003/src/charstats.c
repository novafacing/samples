...
// NOTE: Had to reduce the STATE_SIZE so that the segfault condition is easier
// to trigger - used to be 1024
...
uint8_t DATA8(reg_t r) { return (STATE8(r + REGLIMIT)); }

uint16_t DATA16(reg_t r) { return (STATE16(r + REGLIMIT)); }

uint32_t DATA32(reg_t r) { return (STATE32(r + REGLIMIT)); }

uint8_t REG8(reg_t r) { return (STATE8(r)); }

uint16_t REG16(reg_t r) { return (STATE16(r)); }

uint32_t REG32(reg_t r) { return (STATE32(r)); }

void MOVIM8(reg_t r1, uint8_t im) { STATE8(r1) = im; }

void MOVIM16(reg_t r1, uint16_t im) { STATE16(r1) = im; }

void MOVIM32(reg_t r1, uint32_t im) { STATE32(r1) = im; }

void MOV8(reg_t r1, reg_t r2) { STATE8(r1) = STATE8(r2); }

void MOV16(reg_t r1, reg_t r2) { STATE16(r1) = STATE16(r2); }

void MOV32(reg_t r1, reg_t r2) { STATE32(r1) = STATE32(r2); }
...
void OR8(reg_t r1, reg_t r2, reg_t r3) { STATE8(r1) = STATE8(r2) | STATE8(r3); }
...
void NOT8(reg_t r1, reg_t r2) { STATE8(r1) = ~STATE8(r2); }

void NOT16(reg_t r1, reg_t r2) { STATE16(r1) = ~STATE16(r2); }

void NOT32(reg_t r1, reg_t r2) { STATE32(r1) = ~STATE32(r2); }
...
void LAND8(reg_t r1, reg_t r2, reg_t r3) { AND8(r1, r2, r3); }

void LAND16(reg_t r1, reg_t r2, reg_t r3) { AND16(r1, r2, r3); }

void LAND32(reg_t r1, reg_t r2, reg_t r3) { AND32(r1, r2, r3); }

void LOR8(reg_t r1, reg_t r2, reg_t r3) { OR8(r1, r2, r3); }

void LOR16(reg_t r1, reg_t r2, reg_t r3) { OR16(r1, r2, r3); }
...
void LT8(reg_t r1, reg_t r2, reg_t r3) { GT8(r1, r3, r2); }

void LT16(reg_t r1, reg_t r2, reg_t r3) { GT16(r1, r3, r2); }
...
void INC8(reg_t r1) { ADD8(r1, r1, R_ONE); }

void INC16(reg_t r1) { ADD16(r1, r1, R_ONE); }

void INC32(reg_t r1) { ADD32(r1, r1, R_ONE); }

void DEC8(reg_t r1) { SUB8(r1, r1, R_ONE); }

void DEC16(reg_t r1) { SUB16(r1, r1, R_ONE); }

void DEC32(reg_t r1) { SUB32(r1, r1, R_ONE); }
