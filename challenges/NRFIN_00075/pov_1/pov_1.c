...
int main(void) {
  ...
  do {
    ...
    unsigned int write_00000_len = 0;
    write_00000 =
        append_buf(write_00000, &write_00000_len,
                   (unsigned char *)&t1vals.ipval, write_00000_00000_len);
    if (write_00000_len > 0) {
      transmit_all(1, write_00000, write_00000_len);
    }
    free(write_00000);
  ...
  do {
    //*** writing data
    static unsigned char write_00000_00000[] = "\x20\x80\x00\x00\x00\x20";
  ...
  do {
    ...
    write_00000 =
        append_buf(write_00000, &write_00000_len,
                   (unsigned char *)&t1vals.regval, write_00000_00000_len);
    if (write_00000_len > 0) {
      transmit_all(1, write_00000, write_00000_len);
    }
    free(write_00000);
  ...
  do {
    //*** writing data
    static unsigned char write_00000_00000[] = "\x20\x00\x10\x00\x00\x00";
    static unsigned int write_00000_00000_len = 6;
    unsigned char *write_00000 = NULL;
    unsigned int write_00000_len = 0;
    write_00000 = append_buf(write_00000, &write_00000_len, write_00000_00000,
