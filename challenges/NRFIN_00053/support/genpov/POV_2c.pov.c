...
int main(void) {
  ...
  do {
    //*** writing data
    static unsigned char write_00000_00000[] = "\x31\x37\x0a";
  ...
  do {
    ...
    assign_from_slice("authkey", read_00008, read_00008_len - read_00008_ptr, 0,
                      0, 1);
    free(read_00008);
    if (read_00008_ptr) {
    }  // silence unused variable warning if any
  ...
  do {
    //*** writing data
    static unsigned char write_00004_00000[] = "\x33\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00005_00000[] = "\x31\x31\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00006_00000[] = "\x59\x0a";
  ...
  do {
    ...
    static unsigned char match_00013_00000[] =
        ...
        "\x2e\x0a\x00";
    read_00013_ptr +=
        data_match(read_00013 + read_00013_ptr, read_00013_len - read_00013_ptr,
                   match_00013_00000, 19);
    free(read_00013);
    if (read_00013_ptr) {
    }  // silence unused variable warning if any
  } while (0);
  ...
  do {
    //*** writing data
    static unsigned char write_00007_00000[] = "\x33\x38\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00011_00000[] = "\x72\x71\x59\x70";
  ...
  do {
    //*** writing data
    static unsigned char write_00014_00000[] = "\x31\x34\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00018_00000[] = "\x35\x34\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00019_00000[] = "\x69\x54\x78\x66\x4a\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00021_00000[] = "\x31\x34\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00025_00000[] = "\x31\x38\x0a";
  ...
  do {
    ...
    static unsigned char match_00040_00000[] =
        ...
        "\x35\x2e\x20\x51\x75\x69\x74\x0a\x00";
    read_00040_ptr +=
        data_match(read_00040 + read_00040_ptr, read_00040_len - read_00040_ptr,
                   match_00040_00000, 41);
    free(read_00040);
    if (read_00040_ptr) {
    }  // silence unused variable warning if any
  } while (0);
  ...
  do {
    //*** writing data
    static unsigned char write_00026_00000[] = "\x31\x34\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00030_00000[] = "\x72\x71\x59\x70";
  ...
  do {
    //*** writing data
    static unsigned char write_00032_00000[] = "\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00033_00000[] = "\x33\x36\x0a";
  ...
  do {
    //*** writing data
    static unsigned char write_00034_00000[] = "\x31\x0a";
  ...
  do {
    ...
    //**** delimited read
    static unsigned char read_00050_delim[] = "\x2e";
    read_00050 = NULL;
    read_00050_len = 0;
    int read_00050_res =
    ...
    assign_from_slice("voteid12341234", read_00050,
                      read_00050_len - read_00050_ptr, 0, 0, 1);
    free(read_00050);
    if (read_00050_ptr) {
    }  // silence unused variable warning if any
  } while (0);
  ...
  do {
    //*** writing data
    static unsigned char write_00035_00000[] = "\x39\x35\x0a";
