...
DeclareClass(Monster, Object) char m_name[MONSTER_NAME_LEN];
...
EndDeclareClass(Monster, Object)
    ...
    DeclareClassFunctions(Monster, Object)
        DeclareFunction(Monster, void, init, const kind_data_t *kind,
                        unsigned int level) DeclareFunction(Monster, void, copy,
                                                            Monster *)
                ...
                DeclareFunction(Monster, void, level_up)
                    DeclareFunction(Monster, int, gain_xp, unsigned int xp)
                        ...
                        DeclareFunction(Monster, void, serialize, Buffer *buf)
                            DeclareFunction(Monster, void, deserialize,
                                            Buffer *buf)
