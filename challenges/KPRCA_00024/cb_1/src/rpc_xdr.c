...
int marshal_accept_stat(accept_stat *data, unsigned char **_out,
                        size_t *_size) {
  int _result;
  _result = marshal_int(&(*data), _out, _size);
  CHECK_RESULT();
...
int unmarshal_accept_stat(accept_stat *data, unsigned char **_in,
                          size_t *_size) {
  int _result;
  _result = unmarshal_int(&(*data), _in, _size);
  CHECK_RESULT();
...
int marshal_reject_stat(reject_stat *data, unsigned char **_out,
                        size_t *_size) {
  int _result;
  _result = marshal_int(&(*data), _out, _size);
  CHECK_RESULT();
...
int unmarshal_reject_stat(reject_stat *data, unsigned char **_in,
                          size_t *_size) {
  int _result;
  _result = unmarshal_int(&(*data), _in, _size);
  CHECK_RESULT();
...
int marshal_auth_flavor(auth_flavor *data, unsigned char **_out,
                        size_t *_size) {
  int _result;
  _result = marshal_int(&(*data), _out, _size);
  CHECK_RESULT();
...
int unmarshal_auth_flavor(auth_flavor *data, unsigned char **_in,
                          size_t *_size) {
  int _result;
  _result = unmarshal_int(&(*data), _in, _size);
  CHECK_RESULT();
...
int marshal_opaque_auth(opaque_auth *data, unsigned char **_out,
                        size_t *_size) {
  int _result;
...
int unmarshal_opaque_auth(opaque_auth *data, unsigned char **_in,
                          size_t *_size) {
  int _result;
  ...
  CHECK_RESULT();
  if ((*data).body.count > 400) return -1;
  _result = _checked_calloc((void **)&(*data).body.data, (*data).body.count,
                            sizeof((*data).body.data[0]));
  {
    size_t i;
    for (i = 0; i < (*data).body.count; i++) {
...
int marshal_accepted_reply(accepted_reply *data, unsigned char **_out,
                           size_t *_size) {
  int _result;
  _result = marshal_opaque_auth(&(*data).verf, _out, _size);
  CHECK_RESULT();
  ...
  switch ((*data).reply_data.stat) {
    case PROG_MISMATCH:
      _result = marshal_unsigned_int(
          &(*data).reply_data.value.mismatch_info.low, _out, _size);
      CHECK_RESULT();
      _result = marshal_unsigned_int(
          &(*data).reply_data.value.mismatch_info.high, _out, _size);
      CHECK_RESULT();
      break;
    default:
      break;
    case SUCCESS: {
      ...
      for (i = 0; i < 0; i++) {
        _result =
            marshal_opaque(&(*data).reply_data.value.results[i], _out, _size);
        CHECK_RESULT();
      }
    } break;
  }
...
int unmarshal_accepted_reply(accepted_reply *data, unsigned char **_in,
                             size_t *_size) {
  int _result;
  _result = unmarshal_opaque_auth(&(*data).verf, _in, _size);
  CHECK_RESULT();
  ...
  switch ((*data).reply_data.stat) {
    case PROG_MISMATCH:
      _result = unmarshal_unsigned_int(
          &(*data).reply_data.value.mismatch_info.low, _in, _size);
      CHECK_RESULT();
      _result = unmarshal_unsigned_int(
          &(*data).reply_data.value.mismatch_info.high, _in, _size);
      CHECK_RESULT();
      break;
    default:
      break;
    case SUCCESS: {
      ...
      for (i = 0; i < 0; i++) {
        _result =
            unmarshal_opaque(&(*data).reply_data.value.results[i], _in, _size);
        CHECK_RESULT();
      }
    } break;
  }
...
int marshal_rejected_reply(rejected_reply *data, unsigned char **_out,
                           size_t *_size) {
  int _result;
  ...
  switch ((*data).stat) {
    ...
    case RPC_MISMATCH:
      _result =
          marshal_unsigned_int(&(*data).value.mismatch_info.low, _out, _size);
      CHECK_RESULT();
      _result =
          marshal_unsigned_int(&(*data).value.mismatch_info.high, _out, _size);
      CHECK_RESULT();
      break;
    default:
      return -1;
...
int unmarshal_rejected_reply(rejected_reply *data, unsigned char **_in,
                             size_t *_size) {
  int _result;
  ...
  switch ((*data).stat) {
    ...
    case RPC_MISMATCH:
      _result =
          unmarshal_unsigned_int(&(*data).value.mismatch_info.low, _in, _size);
      CHECK_RESULT();
      _result =
          unmarshal_unsigned_int(&(*data).value.mismatch_info.high, _in, _size);
      CHECK_RESULT();
      break;
    default:
      return -1;
