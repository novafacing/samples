...
static void __DB_CURRENT_db_lookup(rpc_msg *msg, unsigned char *buf,
                                   size_t avail) {
  int _result;
  rpc_msg reply;
  key a0;
...
static void __DB_CURRENT_db_insert(rpc_msg *msg, unsigned char *buf,
                                   size_t avail) {
  int _result;
  rpc_msg reply;
  record a0;
...
static void __DB_CURRENT_db_delete(rpc_msg *msg, unsigned char *buf,
                                   size_t avail) {
  int _result;
  rpc_msg reply;
  key a0;
...
static void __DB_CURRENT_db_next(rpc_msg *msg, unsigned char *buf,
                                 size_t avail) {
  int _result;
  rpc_msg reply;
  key a0;
...
static void __DB_CURRENT_db_prev(rpc_msg *msg, unsigned char *buf,
                                 size_t avail) {
  int _result;
  rpc_msg reply;
  key a0;
...
static void __handle_DB_CURRENT(rpc_msg *msg, unsigned char *buf,
                                size_t avail) {
