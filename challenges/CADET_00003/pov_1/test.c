...
int main(void) {
  do {
    ...
    if (length_read(3, (unsigned char *)type1vals, sizeof(type1vals)) !=
        sizeof(type1vals)) {
      _terminate(4);
    }
  ...
  do {
    ...
    static unsigned char write_00000_00002[] = "\x43\x43\x43\x43";
    static unsigned int write_00000_00002_len = 4;
    static unsigned char write_00000_00004[] = "\x0a";
    ...
    write_00000 = append_buf(write_00000, &write_00000_len, write_00000_00002,
                             write_00000_00002_len);
    write_00000 = append_var("TYPE1_IP", write_00000, &write_00000_len);
    write_00000 = append_buf(write_00000, &write_00000_len, write_00000_00004,
                             write_00000_00004_len);
